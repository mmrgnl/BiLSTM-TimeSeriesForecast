...
data_file = "power-laws-forecasting-energy-consumption-test-data.csv"
...
data = training_data
data_shuffled = data.sample(frac=1, axis=1)
data = data_shuffled
...
pd.DataFrame(y_test).to_csv("Y_test1.csv", index=False)
